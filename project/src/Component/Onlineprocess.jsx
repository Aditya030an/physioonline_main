...
const steps = [
  {
    ...
    description: "Physio enquires about the origin of pain.",
    icon: "https://cdn-icons-png.flaticon.com/512/1827/1827504.png",
  },
  {
    number: "02",
    title: "Clinical Examination",
    description: "Physio makes you do guided movements to identify the root cause of pain.",
    icon: "https://cdn-icons-png.flaticon.com/512/724/724664.png",
  },
  {
    number: "03",
    title: "Medical Reports",
    description: "Physio matches the findings with MRI, CT Scans & Blood reports.",
    icon: "https://cdn-icons-png.flaticon.com/512/2910/2910226.png",
  },
  {
    number: "04",
    title: "Personalized Treatment",
    description: "Physio educates about the reason of the pain using 3D Tech. & creates a personalized treatment plan.",
...
const PhysiotherapyProcess = () => {
  return (
    <div className="relative flex flex-col items-center py-20 bg-[#F1FAEE] overflow-hidden">
      ...
      >
        Online Physiotherapy <span className="text-yellow-500">Booking</span>
      </motion.h2>
      <motion.h3
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
